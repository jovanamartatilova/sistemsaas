...
navLabel: {
  ...
  statValueSm: { fontSize: "22px", fontWeight: 800, color: "#0f172a", lineHeight: 1, marginBottom: "4px" },
...
// ============ DATA ============
const statCards = [
  { value: 18, valueSize: "big", label: "Paid Interns", badge: null, sub: "Active paid program", barColor: "#3b82f6", barWidth: "58%" },
  { value: 14, valueSize: "big", label: "Paid This Month", badge: "Done", badgeBg: "#dcfce7", badgeColor: "#166534", sub: "Transfer completed", barColor: "#22c55e", barWidth: "78%" },
  { value: 4, valueSize: "big", label: "Pending Payment", badge: "Pending", badgeBg: "#fef9c3", badgeColor: "#92400e", sub: "Needs to be processed", barColor: "#f59e0b", barWidth: "22%" },
  { value: "Rp 28.4M", valueSize: "sm", label: "Total Disbursed", badge: null, sub: "This month", barColor: "#8b5cf6", barWidth: "70%" },
];

const payrollList = [
  { name: "Budi Santoso", email: "budi@gmail.com", position: "Backend Dev", program: "Regular Batch 3", stipend: "Rp 1,500,000", bank: "BCA · 1234xxxx", status: "Paid", statusBg: "#dcfce7", statusColor: "#166534" },
  { name: "Dian Purnama", email: "dian@email.com", position: "Backend Dev", program: "Regular Batch 3", stipend: "Rp 1,500,000", bank: "BNI · 5678xxxx", status: "Paid", statusBg: "#dcfce7", statusColor: "#166634", isPaid: true },
  { name: "Nisa Rahmah", email: "nisa@email.com", position: "UI Designer", program: "Flagship Batch 2", stipend: "Rp 2,000,000", bank: "Mandiri · 9012xxxx", status: "Pending", statusBg: "#fef9c3", statusColor: "#92400e", showPay: true },
  { name: "Sari Dewi", email: "sari@yahoo.com", position: "UI Designer", program: "Flagship Batch 2", stipend: "Rp 2,000,000", bank: "BCA · 3456xxxx", status: "Pending", statusBg: "#fef9c3", statusColor: "#92400e", showPay: true },
  { name: "Hendra Wijaya", email: "hendra@email.com", position: "Backend Dev", program: "Regular Batch 3", stipend: "Rp 1,500,000", bank: "BRI · 7890xxxx", status: "Paid", statusBg: "#dcfce7", statusColor: "#166534" },
  { name: "Rizki Hakim", email: "rizki@email.com", position: "Data Analyst", program: "Independent", stipend: "Rp 1,200,000", bank: "BCA · 2345xxxx", status: "Pending", statusBg: "#fef9c3", statusColor: "#92400e", showPay: true },
  { name: "Putri Ayu", email: "putri@email.com", position: "UI Designer", program: "Flagship Batch 2", stipend: "Rp 2,000,000", bank: "BNI · 6789xxxx", status: "Paid", statusBg: "#dcfce7", statusColor: "#166534" },
];
          ...
          <div style={s.statGrid}>
            {statCards.map((card, i) => (
              <div key={i} style={s.statCard}>
                ...
                <div style={card.valueSize === "sm" ? s.statValueSm : s.statValue}>{card.value}</div>
          ...
          <div style={s.card}>
            <div style={s.cardHeader}>
              <div>
                ...
                <div style={s.cardSubtitle}>Paid internship participants — Mar 2026</div>
              </div>
            ...
            <div style={s.tableWrap}>
              <table style={s.table}>
                ...
                <tbody>
                  {payrollList.map((p, i) => (
                    <tr key={i}>
                      <td style={s.td}><span style={s.candidateName}>{p.name}</span><span style={s.candidateEmail}>{p.email}</span></td>
                      <td style={s.td}>{p.position}</td>
                      <td style={s.td}>{p.program}</td>
                      <td style={s.td}>{p.stipend}</td>
                      <td style={s.td}>{p.bank}</td>
                      <td style={s.td}><span style={s.miniBadge(p.statusBg, p.statusColor)}>{p.status}</span></td>
                      <td style={s.td}>
                        <div style={s.actions}>
                          <button style={s.btnAction}>Detail</button>
                          {p.showPay && <button style={s.btnPay}>Pay Now</button>}
                        </div>
                      </td>
                    </tr>
                  ))}
