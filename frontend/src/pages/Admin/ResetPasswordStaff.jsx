...
export default function ResetPasswordStaff() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || "http://localhost:8000/api"}/auth/reset-password-staff`, {
        method: "POST",
        headers: {
    ...
    <div className="min-h-screen w-full flex">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 pb-32 w-full h-full">
          ...
          {/* Company badge + Staff Portal - SEJAJAR */}
          <div className="flex items-center gap-3 mb-6">
            ...
            {/* Staff Portal badge - SEJAJAR dengan company name */}
            <div
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm" style={{ color: "rgba(255,255,255,0.4)", maxWidth: "320px", margin: "0 auto" }}>
              Create a new, strong password for your staff account.
            </p>
          </div>
