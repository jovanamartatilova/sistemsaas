...
export default function ResetPasswordCandidate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL || "http://localhost:8000/api"}/auth/reset-password-candidate`, {
        method: "POST",
        headers: {
      ...
      >
        ...
        <div className="relative z-10 flex flex-col justify-end p-12 pb-32 w-full h-full">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            {/* Tagline - SEJAJAR dengan company name */}
            <div
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm" style={{ color: "rgba(255,255,255,0.4)", maxWidth: "320px", margin: "0 auto" }}>
              Create a new, strong password for your candidate account.
            </p>
          </div>
