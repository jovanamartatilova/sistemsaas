        ...
        return (
            ...
            >
                <div className="text-center max-w-sm">
                    ...
                    <button
                        onClick={() => navigate("/")}
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold text-white bg-transparent border-none cursor-pointer"
                        style={{ background: "linear-gradient(135deg, #2d7dd2 0%, #4a9eff 100%)", boxShadow: "0 4px 20px rgba(74,158,255,0.3)", outline: "none" }}
                    >
                        Back to Home
                    </button>
                </div>
        ...
        <div className="min-h-screen w-full flex">
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background: "linear-gradient(to bottom, rgba(10,22,40,0.3) 0%, rgba(10,22,40,0.6) 60%, rgba(10,22,40,0.95) 100%)",
                    }}
                />
                ...
                <div className="relative z-10 flex flex-col justify-end p-12 pb-32">
                    ...
                    {company && (
                        ...
                        >
                            ...
                            <span className="text-xs font-medium" style={{ color: "#5dd8d8" }}>
                                {company.name}
                            </span>
                        </div>
                    )}
                ...
                <div className="w-full max-w-md relative z-10 text-left">
                    ...
                    <div className="text-center mb-6">
                        ...
                        <h1 className="text-2xl font-bold text-white mb-1" style={{ letterSpacing: "-0.3px" }}>
                            Welcome To{" "}
                            {companyLoading ? (
                                <span className="inline-block w-32 h-6 rounded animate-pulse align-middle" style={{ background: "rgba(255,255,255,0.1)" }} />
                            ) : (
                                <span style={{ color: "#4a9eff" }}>{company?.name ?? "EarlyPath"}</span>
                            )}
                        </h1>
                        <p className="text-sm" style={{ color: "rgba(255,255,255,0.45)" }}>
                            Create your account and start exploring internship opportunities.
                        </p>
                    </div>
