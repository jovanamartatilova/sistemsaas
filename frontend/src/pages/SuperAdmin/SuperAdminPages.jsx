...
export function SuperAdminSidebar({ onLogout, unreadCount = 0, isOpen, onClose }) {
  ...
  return (
    <>
      ...
      <aside style={sidebarStyle} className={`sidebar-mobile${isOpen ? " open" : ""}`}>
...
aside.sidebar-mobile.open { display: flex; position: fixed; top: 0; left: 0; z-index: 200; height: 100vh; }
